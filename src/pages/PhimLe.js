...
const PhimLe = () => {
  ...
  useEffect(() => {
    const fetchSeriesMovies = async () => {
      try {
        const response = await axios.get('https://ophim1.com/v1/api/danh-sach/phim-le');
        // Truy cập mảng items trong response.data.data
    ...
    <div className='bg-[#111827] text-white'>
      ...
      <div className="flex pt-32 flex-col lg:flex-row">
        ...
        <div className="lg:w-4/5 w-full p-5">
          <h1 className="text-3xl font-bold mb-6 uppercase">Danh Sách Phim Lẻ</h1>
